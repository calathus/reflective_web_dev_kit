...
In which genric/mirror based approach are employed systematically.
...
[json_mapper] 
json mapping based on mirror library. this automatically map jason to corresponding entity instance

[coucdb] 
dao api for couchdb based on mirror/json_mapper. this provides server side json_proxy, and client side couchdb dao library

[gui_component] 
a framework to create web app using component based desigen, also table/form are implemented as genric class using mirror.
...
3) shoudl use annotation to allow more copntrol over the GUI presentation for gui_components.
4) use AOP style inhection for DB access/logging.
...
...
eventually I will fix some of teh remaining issues.
...
![alt tag](https://github.com/calathus/reflective_web_dev_kit/doc/sample_app.png)
